...
namespace Incontrl.Net.Abstractions
{
    public interface IContactApi
    {
        ...
        /// <summary>
        /// Creates an instance of class ContactCompaniesApi, that provides functionality to retrieve the companies of the specific contact when an invoice has been created for it.
        /// </summary>
