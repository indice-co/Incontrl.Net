...
namespace Incontrl.Net.Services
{
    internal class SubscriptionsApi : ISubscriptionsApi
    {
        ...
        public async Task<JsonResponse<ResultSet<Subscription>>> ListAsync(ListOptions<SubscriptionListFilter> options = null, CancellationToken cancellationToken = default(CancellationToken)) => 
