...
namespace Incontrl.Sdk.Abstractions
{
    public interface ITaxApi
    {
        ...
        Task<TaxDefinition> GetAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Returns the task object representing the asynchronous operation.</returns>
        Task<TaxDefinition> UpdateAsync(TaxDefinition request, CancellationToken cancellationToken = default(CancellationToken));
    }
}
